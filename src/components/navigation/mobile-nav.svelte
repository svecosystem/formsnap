<script lang="ts">
	...
	import { SquareHalf } from "@/components/icons/index.js";
	import { Button } from "@/components/ui/button/index.js";
	import { siteConfig, navigation } from "@/config/index.js";
	...
	<Sheet.Content side="left" class="pr-0">
		...
		<div class="my-4 h-[calc(100vh-8rem)] pb-10 pl-6 overflow-auto">
			<div class="flex flex-col space-y-3">
				{#each navigation.main as navItem, index (navItem + index.toString())}
					{#if navItem.href}
